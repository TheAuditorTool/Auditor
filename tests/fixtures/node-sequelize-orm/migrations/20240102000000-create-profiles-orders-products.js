/**
 * Migration: Create profiles, orders, and products tables
 * Tests: One-to-one and many-to-many relationships
 */
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable('products', {
      ...
      status: {
        type: Sequelize.ENUM('active', 'inactive', 'discontinued', 'out_of_stock'),
        defaultValue: 'active',
        allowNull: false
      },
      featured: {
    ...
    // Create order_products junction table (many-to-many)
    ...
    await queryInterface.addIndex('order_products', ['orderId', 'productId'], { unique: true });
  },
