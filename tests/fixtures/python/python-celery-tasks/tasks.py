...
def trigger_tasks():
    ...
    send_email.apply_async(args=["user@example.com", "Hello", "Message body"], countdown=10)

    process_data.delay("data_123")

    custom_named_task.apply_async(args=["test"], eta=datetime.now() + timedelta(minutes=5))
...
app.conf.beat_schedule = {
    ...
    "send-report-monday-morning": {
        ...
        "kwargs": {"to": "admin@example.com", "subject": "Weekly Report", "body": "Report content"},
    },
    "process-hourly": {
