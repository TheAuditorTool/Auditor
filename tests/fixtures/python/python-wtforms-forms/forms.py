...
class RegistrationForm(FlaskForm):
    ...
    confirm_password = PasswordField(
        "Confirm Password", [EqualTo("password", message="Passwords must match")]
    )
    age = IntegerField("Age", [NumberRange(min=13, max=120)])
...
class BlogPostForm(FlaskForm):
    ...
    category = SelectField(
        "Category", choices=[("tech", "Technology"), ("life", "Lifestyle"), ("news", "News")]
    )
