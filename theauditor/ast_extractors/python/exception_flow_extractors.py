...
def extract_exception_raises(tree: Dict, parser_self) -> List[Dict[str, Any]]:
...
def extract_exception_catches(tree: Dict, parser_self) -> List[Dict[str, Any]]:
...
def extract_finally_blocks(tree: Dict, parser_self) -> List[Dict[str, Any]]:
...
def extract_context_managers(tree: Dict, parser_self) -> List[Dict[str, Any]]:
    ...
    def classify_resource_type(context_expr: str) -> Optional[str]:
