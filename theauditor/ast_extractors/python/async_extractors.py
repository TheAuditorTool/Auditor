...
def extract_async_functions(tree: Dict, parser_self) -> List[Dict[str, Any]]:
...
def extract_await_expressions(tree: Dict, parser_self) -> List[Dict[str, Any]]:
...
def extract_async_generators(tree: Dict, parser_self) -> List[Dict[str, Any]]:
